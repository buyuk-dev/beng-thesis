...
class DataFrame:
    ...
    def __str__(self):
        return "DataFrame object:\n" \
               ...
               "label: {2}\n" \
               "timestamps: {3}\n" \
               "eeg: {4}".format(self.userid, self.playback_info, self.label, self.timestamps, self.eeg_data)
...
if __name__ == '__main__':
    ...
    playback_info = {'playback_id': '12345', 'playback_start': '2020-01-01 12:00:00', 'playback_end': '2020-01-01 12:00:10'}
    timestamps = {'labeling_start': '2020-01-01 12:00:05', 'labeling_end': '2020-01-01 12:00:10'}
    label = 'happy'
    userid = '12345'
